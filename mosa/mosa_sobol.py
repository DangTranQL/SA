...
class custom_mosa():
    def __init__(self, initial_temp=1000, final_temp=0.01, cooling_rate=0.95, num_iterations=1, step_size=0.1):
    ...
    def run_mosa_adaptive(self, runs=3, batch_size=4096, explore_frac=0.5, refine_step=0.05, use_tqdm=True):
        """
